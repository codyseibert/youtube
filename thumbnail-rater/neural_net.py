...
def create_model(a=64, b=32, c=32, dropout_rate=0.3, optimizer='Adam', kernel_size=3):
	model = Sequential()
	model.add(Conv2D(a, kernel_size=kernel_size, activation='relu', input_shape = (IMG_SIZE_H, IMG_SIZE_W, 3)))
